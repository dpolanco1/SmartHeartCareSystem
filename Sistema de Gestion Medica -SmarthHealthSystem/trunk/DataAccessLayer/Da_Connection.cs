        ...
        private Da_Connection() { }
                ...
                public static SqlConnection Get
                {
                    get
                    {
                        ...
                        if (_connection == null)
                            _connection = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["jajajaaPresentationLayer.Properties.Settings.SmartHearthCareDbConnectionStringDelcio"].ToString());
